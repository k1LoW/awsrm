...
RSpec.describe Awsrm::VpnConnection do
  ...
  it '#filters' do
    expect(Awsrm::VpnConnection.filters(id: 'vpn-cg5692g4')).to eq [{ name: 'vpn-connection-id', values: ['vpn-cg5692g4'] }]
    expect(Awsrm::VpnConnection.filters(vpn_connection_id: 'vpn-cg5692g4')).to eq [{ name: 'vpn-connection-id', values: ['vpn-cg5692g4'] }]
